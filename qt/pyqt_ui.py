...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.recommend_button_2.setIcon(QtGui.QIcon('./r1.jpg'))
        ...
        self.recommend_button_3.setIcon(QtGui.QIcon('./r1.jpg'))
        ...
        self.recommend_button_4.setIcon(QtGui.QIcon('./r1.jpg'))
        ...
        self.recommend_button_5.setIcon(QtGui.QIcon('./r1.jpg'))
        ...
        self.playlist_button_2.setIcon(QtGui.QIcon('./r1.jpg'))
        ...
        self.playlist_button_3.setIcon(QtGui.QIcon('./r1.jpg'))
        ...
        self.playlist_button_4.setIcon(QtGui.QIcon('./r1.jpg'))
