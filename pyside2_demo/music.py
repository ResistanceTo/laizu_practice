...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.recommend_button_1.setIcon(QtGui.QIcon('./d.ico'))  # 设置按钮图标
        ...
        self.recommend_button_2.setIcon(QtGui.QIcon('./d.ico'))
        ...
        self.recommend_button_3.setIcon(QtGui.QIcon('./d.ico'))
        ...
        self.recommend_button_4.setIcon(QtGui.QIcon('./d.ico'))
        ...
        self.recommend_button_5.setIcon(QtGui.QIcon('./d.ico'))
        ...
        self.playlist_button_1.setIcon(QtGui.QIcon('./d.ico'))
        ...
        self.playlist_button_2.setIcon(QtGui.QIcon('./d.ico'))
        ...
        self.playlist_button_3.setIcon(QtGui.QIcon('./d.ico'))
        ...
        self.playlist_button_4.setIcon(QtGui.QIcon('./d.ico'))
